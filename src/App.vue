  ...
  <v-app id="inspire">
    ...
    <v-app-bar :clipped-left="$vuetify.breakpoint.lgAndUp" app color="blue darken-3" dark>
      ...
      <v-toolbar-title style="width: 300px" class="ml-0 pl-4">
        <span class="hidden-sm-and-down">KiBucDu</span>
      </v-toolbar-title>
      <v-text-field
        flat
        solo-inverted
      ...
      <v-btn icon>
        <v-avatar color="primary">
          <span class="white--text headline">SL</span>
        </v-avatar>
      </v-btn>
    </v-app-bar>
...
export default {
  ...
  data: () => ({
    ...
    items: [
      ...
      { icon: 'mdi-book-open-variant', text: 'Mein Kirchbuch' },
      { icon: 'mdi-content-copy', text: 'Recherche', link: '/research' },
      // {
      //   icon: 'mdi-chevron-up',
      ...
      //   ],
      // },
      { icon: 'mdi-archive', text: 'Archiv' },
      { icon: 'mdi-archive', text: 'Pfarreiinfo' },
      { icon: 'mdi-archive', text: 'Einstellungen' },
      { icon: 'mdi-help-circle', text: 'Hilfe' }
    ]
  })
};
</script>
